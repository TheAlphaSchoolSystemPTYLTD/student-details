...
* **Sample GET:** (With URL Encoded `token`)
  ...
  ```HTML
    http://api.tasscloud.com.au/tassweb/api/?method=getConfNotes&appcode=API10&company=10&v=3&token=l1D8owEn111IHcXLRwXTB0oU2GX6rj%2BISqa9zXA8We3J3mwgjW5pdUvFK3%2FIZ4mJ4bMyfKTmEoup%2B3tTE9GeLQ%3D%3D
  ```
